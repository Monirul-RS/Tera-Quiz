...
const Blog = () => {
    return (
        <div>
            ...
            <div className='m-10 border-2 rounded-xl p-6 lg:w-4/5 mx-auto mt-8 bg-slate-50 shadow-lg shadow-indigo-600'>
                <p className='text-3xl text-left text-sky-700 font-bold mb-4 '>1.What is the purpose of react-router??</p>
            ...
            <div className='m-10 border-2 rounded-xl p-6 lg:w-4/5 mx-auto mt-8 bg-slate-50 shadow-lg shadow-indigo-600'>
                <p className='text-3xl text-left text-sky-700 font-bold mb-4'>2.How does context API works??</p>
            ...
            <div className='m-10 border-2 rounded-xl p-6 lg:w-4/5 mx-auto mt-8 bg-slate-50 shadow-lg shadow-indigo-600'>
                <p className='text-3xl text-left text-sky-700 font-bold mb-4'>3.What is useRef hook reactJS??</p>
